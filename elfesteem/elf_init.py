...
class StructWrapper(metaclass=StructWrapperMC):
    wrapped = None
...
class Section(metaclass=SectionMC):
    sectypes = {}
...
class StrTable(Section):
    ...
    def mod_name(self, name, new_name):
        ...
        s = s.replace(b'\x00' + name + b'\x00', b'\x00' + new_name + b'\x00')
        self.content = s
